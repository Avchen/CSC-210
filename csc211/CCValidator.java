...
//        int totalSum = doubleEvenSum + oddSum;
//
...
//    /**
//     * Get the result from Step 2
//     * Multiply all even digits by two, if the result is a two digit number,
//     * sum up the digits of number, and sum up all results
//     */
//    public static int sumOfDoubleEvenPlace(long number) {
//        int[] arrNum = new int[getSize(number)];
//        int index = arrNum.length-1;
//        while (number > 0){
//            arrNum[index] = number % 10;
//            number /= 10;
//        }
//        for (int i = 0; i < arrNum.length; i++) {
//            if( i % 2 == 0) {
//                sum += getDigit(arrNum*2);
//            }
//        }
//
//        return sum;
...
//        long prefixRetrieved = getPrefix( number, getSize(prefix));
//        return prefixRetrieved == prefix;
//    }
//
//    /**
//     * Return the number of digits in d
//     */
//    public static int getSize(long creditCardNum) {
//        int counter = 0;
